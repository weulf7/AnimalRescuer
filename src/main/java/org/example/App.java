...
public class App 
{
    public static void main( String[] args )
    {
        ...
        petfood1.amount = 5  ;
        petfood1.availability = true;
        petfood1.energyRestore = 4;

        petfood1.foodType ="dog food";
        petfood1.healthRestorePoint = 4;
        petfood1.name ="DoggyFood";
        petfood1.price = 10;
        petfood1.spiritRestore = 3;
